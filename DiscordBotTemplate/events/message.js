...
module.exports = async (client, message) => {
  ...
  // InviteLink will deny anyone in your server that wants to share their discord link
  let inviteLink = ["discord.gg", "discord.com/invite", "discordapp.com/invite"];

  if (inviteLink.some(word => message.content.toLowerCase().includes(word))) {
    await message.delete();
    return message.reply("Wants to promote his discord server in here... Warn for you my friend!!")
  }

  if (!message.content.startsWith(prefix)) return;


  // This will declare args, msg, cmd and sender
