const Discord = require("discord.js"),
  fs = require("fs"); // fs stands for file system - makes it easier to find all your commands

// Please be careful, this code will makes you confusing and it will risks an error if you don't try to focus it.

module.exports = client => {
  client.commands = new Discord.Collection(); // A Collection To Collect All Of Your Commands
  client.aliases = new Discord.Collection(); // A Collection To Collect All Of Your Aliases
  client.helps = new Discord.Collection(); // A Collection To Collect All Of Your Essentials

  fs.readdir("./commands/", (err, categories) => {
    if (err) console.log(err) // it will send you an error if something went wrong.
